...
namespace ServiceCenter.MES.DataAccess.ZPVM
{
    ...
    /// 实现物料替换规则数据访问类。
    /// </summary>
    public class SupplierToManufacturerDataEngine
        : DatabaseDataEngine<SupplierToManufacturer, SupplierToManufacturerKey>
        , ISupplierToManufacturerDataEngine
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        /// <param name="sf">The sf.</param>
        public SupplierToManufacturerDataEngine(ISessionFactory sf)
            : base(sf)
        {
        }
    }
