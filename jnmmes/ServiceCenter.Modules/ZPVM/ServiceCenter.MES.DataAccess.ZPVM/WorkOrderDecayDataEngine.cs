...
namespace ServiceCenter.MES.DataAccess.ZPVM
{
    ...
    /// 实现工单衰减设置数据访问类。
    /// </summary>
    public class WorkOrderDecayDataEngine
        : DatabaseDataEngine<WorkOrderDecay, WorkOrderDecayKey>
        , IWorkOrderDecayDataEngine
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        /// <param name="sf">The sf.</param>
        public WorkOrderDecayDataEngine(ISessionFactory sf)
            : base(sf)
        {
        }
    }
