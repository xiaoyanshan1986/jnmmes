...
namespace ServiceCenter.MES.DataAccess.ZPVM
{
    ...
    /// 实现IV测试数据访问类。
    /// </summary>
    public class ColorTestDataDataEngine: DatabaseDataEngine<ColorTestData, ColorTestDataKey>, IColorTestDataDataEngine
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        /// <param name="sf">The sf.</param>
        public ColorTestDataDataEngine(ISessionFactory sf)
            : base(sf)
        {
        }
    }
