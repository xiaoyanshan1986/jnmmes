...
namespace ServiceCenter.MES.DataAccess.ZPVM
{
    ...
    /// 实现子分档数据访问类。
    /// </summary>
    public class PowersetDetailDataEngine
        : DatabaseDataEngine<PowersetDetail, PowersetDetailKey>
        , IPowersetDetailDataEngine
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        /// <param name="sf">The sf.</param>
        public PowersetDetailDataEngine(ISessionFactory sf)
            : base(sf)
        {
        }
    }
