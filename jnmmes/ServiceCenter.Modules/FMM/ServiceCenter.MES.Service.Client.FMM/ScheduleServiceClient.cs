...
// ***********************************************************************
// <copyright file="ScheduleServiceClient.cs" company="">
...
namespace ServiceCenter.MES.Service.Client.FMM
{
    ...
    /// 定义排班计划管理契约调用方式。
    /// </summary>
    public class ScheduleServiceClient : ClientBase<IScheduleContract>, IScheduleContract, IDisposable
    {
        /// <summary>
        ...
        public async Task<MethodReturnResult> AddAsync(Schedule obj)
        {
        ...
        /// <param name="obj">排班计划数据。</param>
        /// <returns><see cref="MethodReturnResult" />.</returns>
        public ServiceCenter.Model.MethodReturnResult Modify(Schedule obj)
        {
        ...
        /// <param name="obj">The object.</param>
        /// <returns>Task&lt;MethodReturnResult&gt;.</returns>
        public async Task<MethodReturnResult> ModifyAsync(Schedule obj)
        {
            return await Task.Run<MethodReturnResult>(() =>
            {
                return base.Channel.Modify(obj);
        ...
        /// <returns>Task&lt;MethodReturnResult&lt;Schedule&gt;&gt;.</returns>
        public async Task<MethodReturnResult<Schedule>> GetAsync(string key)
        {
            return await Task.Run<MethodReturnResult<Schedule>>(() =>
            {
                return base.Channel.Get(key);
            });
        }
        ...
        public MethodReturnResult<IList<Schedule>> Get(ref ServiceCenter.Model.PagingConfig cfg)
        {
