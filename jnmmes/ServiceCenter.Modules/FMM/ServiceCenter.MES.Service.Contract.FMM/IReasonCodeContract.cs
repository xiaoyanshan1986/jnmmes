...
namespace ServiceCenter.MES.Service.Contract.FMM
{
    ...
    /// </summary>
     [ServiceContract]
    public interface IReasonCodeContract
    {
         /// <summary>
         /// 添加代码数据。
         /// </summary>
         ...
         [OperationContract]
         MethodReturnResult Add(ReasonCode obj);
         /// <summary>
         /// 修改代码数据。
         /// </summary>
         /// <param name="obj">代码数据。</param>
         /// <returns><see cref="MethodReturnResult" /></returns>
         [OperationContract]
         MethodReturnResult Modify(ReasonCode obj);
         /// <summary>
         /// 删除代码数据。
         /// </summary>
         ...
         [OperationContract]
         MethodReturnResult<ReasonCode> Get(string key);
         /// <summary>
         /// 获取代码数据集合。
         /// </summary>
         ...
         MethodReturnResult<IList<ReasonCode>> Get(ref PagingConfig cfg);
    }
}
