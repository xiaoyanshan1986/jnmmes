...
namespace ServiceCenter.MES.Service.Contract.FMM
{
    ...
    /// </summary>
     [ServiceContract]
    public interface IReasonCodeCategoryContract
    {
         /// <summary>
         /// 添加代码分组数据。
         /// </summary>
         ...
         [OperationContract]
         MethodReturnResult Add(ReasonCodeCategory obj);
         /// <summary>
         /// 修改代码分组数据。
         /// </summary>
         /// <param name="obj">代码分组数据。</param>
         /// <returns><see cref="MethodReturnResult" /></returns>
         [OperationContract]
         MethodReturnResult Modify(ReasonCodeCategory obj);
         /// <summary>
         /// 删除代码分组数据。
         /// </summary>
         ...
         [OperationContract]
         MethodReturnResult<ReasonCodeCategory> Get(string key);
         /// <summary>
         /// 获取代码分组数据集合。
         /// </summary>
         ...
         MethodReturnResult<IList<ReasonCodeCategory>> Get(ref PagingConfig cfg);
    }
}
