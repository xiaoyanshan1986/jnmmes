...
namespace ServiceCenter.MES.DataAccess.WIP
{
    ...
    /// 在制品批次属性数据访问类。
    /// </summary>
    public class LotAttributeDataEngine
        : DatabaseDataEngine<LotAttribute, LotAttributeKey>
        , ILotAttributeDataEngine
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        /// <param name="sf">The sf.</param>
        public LotAttributeDataEngine(ISessionFactory sf)
            : base(sf)
        {
        }
    }
