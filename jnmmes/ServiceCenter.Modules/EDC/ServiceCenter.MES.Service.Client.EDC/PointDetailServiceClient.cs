...
// ***********************************************************************
// <copyright file="PointDetailServiceClient.cs" company="">
...
namespace ServiceCenter.MES.Service.Client.EDC
{
    ...
    /// 定义采集点设置明细管理契约调用方式。
    /// </summary>
    public class PointDetailServiceClient : ClientBase<IPointDetailContract>, IPointDetailContract, IDisposable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PointDetailServiceClient" /> class.
        /// </summary>
        public PointDetailServiceClient() {
        }
        ...
        public PointDetailServiceClient(string endpointConfigurationName) : 
        ...
        public PointDetailServiceClient(string endpointConfigurationName, string remoteAddress) : 
        ...
        /// <param name="endpointConfigurationName">Name of the endpoint configuration.</param>
        /// <param name="remoteAddress">The remote address.</param>
        public PointDetailServiceClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        ...
        /// <param name="remoteAddress">The remote address.</param>
        public PointDetailServiceClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
        ...
        /// <param name="obj">The object.</param>
        /// <returns>Task&lt;MethodReturnResult&gt;.</returns>
        public async Task<MethodReturnResult> ModifyAsync(PointDetail obj)
        {
            return await Task.Run<MethodReturnResult>(() =>
            {
                return base.Channel.Modify(obj);
        ...
        public MethodReturnResult<IList<PointDetail>> Get(ref ServiceCenter.Model.PagingConfig cfg)
        {
