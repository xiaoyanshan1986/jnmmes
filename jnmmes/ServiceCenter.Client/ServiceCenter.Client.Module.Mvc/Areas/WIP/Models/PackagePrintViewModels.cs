...
{
    public class PackagePrintViewModel
    {
        public PackagePrintViewModel()
        {
            this.PrintQty = 1;
        }
        ...
        [Required]
        [Display(Name = "PackagePrintViewModel_PrinterName", ResourceType = typeof(WIPResources.StringResource))]
        ...
        [Required]
        [Display(Name = "PackagePrintViewModel_PrintLabelCode", ResourceType = typeof(WIPResources.StringResource))]
        [StringLength(50, MinimumLength = 1
                , ErrorMessageResourceName = "ValidateStringLength"
                , ErrorMessageResourceType = typeof(StringResource))]
        ...
        [Required]
        [Display(Name = "PackagePrintViewModel_PrintQty", ResourceType = typeof(WIPResources.StringResource))]
        [Range(1, 10
