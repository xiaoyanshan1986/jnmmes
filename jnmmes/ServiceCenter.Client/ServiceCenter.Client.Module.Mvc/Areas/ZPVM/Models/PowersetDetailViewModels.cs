...
{
    public class PowersetDetailQueryViewModel
    {
        public PowersetDetailQueryViewModel()
        {
        ...
        [Display(Name = "PowersetDetailQueryViewModel_SubCode", ResourceType = typeof(ZPVMResources.StringResource))]
        public string SubCode { get; set; }
    }

    public class PowersetDetailViewModel
    {
        public PowersetDetailViewModel()
        {
            this.IsUsed = true;
