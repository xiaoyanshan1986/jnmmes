...
namespace ServiceCenter.Client.Mvc.Areas.ERP.Models
{
    ...
    public class MaterialReceiptReplaceViewModel
    {
        public MaterialReceiptReplaceViewModel()
        {
        ...
        [Display(Name = "原物料批号")]
        public string OldMaterialLot { get; set; }
        ...
        [Display(Name = "电池片效率")]
        public string CellPower { get; set; }

        [Display(Name = "电池片等级")]
        public string CellGrade { get; set; }

        [Display(Name = "原电池片花色")]
        public string OldCellColor { get; set; }
        ...
        [Display(Name = "原生产厂商代码")]
        public string OldManufacturerCode { get; set; }

        [Display(Name = "原生产厂商名称")]
        public string OldManufacturerName { get; set; }

        [Display(Name = "现生产厂商代码")]
        public string ManufacturerCode { get; set; }

        [Display(Name = "现生产厂商名称")]
        public string ManufacturerName { get; set; }

        [Display(Name = "供应商物料批号")]
        public string SupplierMaterialLot { get; set; }
