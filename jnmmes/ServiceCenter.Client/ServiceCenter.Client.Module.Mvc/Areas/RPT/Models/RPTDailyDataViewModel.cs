...
namespace ServiceCenter.Client.Mvc.Areas.RPT.Models
{
    ...
    /// 
    /// </summary>
    public class RPTDailyDataViewModel
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        public RPTDailyDataViewModel()
        {
            PageNo = 0;
            PageSize = 20;
        }
        ...
        /// 报表代码
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_ReportCode", ResourceType = typeof(RPTResources.StringResource))]
        public string ReportCode { get; set; }

        /// <summary>
        /// 报表名称
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_ReportName", ResourceType = typeof(RPTResources.StringResource))]
        public string ReportName { get; set; }

        /// <summary>
        /// 开始日期
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_StartDate", ResourceType = typeof(RPTResources.StringResource))]
        public string StartDate { get; set; }

        /// <summary>
        /// 结束日期
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_EndDate", ResourceType = typeof(RPTResources.StringResource))]
        public string EndDate { get; set; }

        /// <summary>
        /// 车间代码
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_LocationName", ResourceType = typeof(RPTResources.StringResource))]
        public string LocationName { get; set; }

        /// <summary>
        /// 线别代码
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_LineCode", ResourceType = typeof(RPTResources.StringResource))]
        public string LineCode { get; set; }

        /// <summary>
        /// 工单
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_OrderNumber", ResourceType = typeof(RPTResources.StringResource))]
        public string OrderNumber { get; set; }

        /// <summary>
        /// 产品型号
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_ProductID", ResourceType = typeof(RPTResources.StringResource))]
        public string ProductID { get; set; }

        /// <summary>
        /// 班别
        /// </summary>
        [Display(Name = "RPTDailyDataViewModel_SchedulingCode", ResourceType = typeof(RPTResources.StringResource))]
