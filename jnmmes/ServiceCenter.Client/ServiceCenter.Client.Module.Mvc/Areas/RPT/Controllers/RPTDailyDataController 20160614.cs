...
{
    public class RPTDailyDataController20160614 : Controller
    {
        /// <summary>
        /// 创建数据列表
        /// </summary>
                ...
                foreach (DataRow datarow in dtData.Rows)
                {
                    ...
                    foreach (DataColumn datacolum in dtData.Columns)
                    {
                        ...
                        if (drawChart == true && (datacolum.ColumnName.ToString().StartsWith("data") || datacolum.ColumnName.ToString().Equals("SUM")))
                        {
                            ...
                            {
                                snAxis = snAxis + "[" + iIndex.ToString() + "," + datarow[datacolum].ToString().Substring(0,datarow[datacolum].ToString().Length - 1) + "]";
                            }
                            else
                            {
        ...
        {
            RPTDailyDataViewModel model = new RPTDailyDataViewModel
            {
                //初始化参数
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Query(RPTDailyDataViewModel model)
        {
            MethodReturnResult result = new MethodReturnResult();
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult DetailIndex(RPTDailyDataViewModel model)
        {
            //return View(model);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult QueryModuleDetailForCharts(RPTDailyDataViewModel model)
        {
            MethodReturnResult result = new MethodReturnResult();
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult QueryModuleDetail(RPTDailyDataViewModel model)
        {
            MethodReturnResult result = new MethodReturnResult();
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult ListDetailIndex(RPTDailyDataViewModel model)
        {
            return View(model);
        }
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult QueryModuleList(RPTDailyDataViewModel model)
        {
            MethodReturnResult result = new MethodReturnResult();            
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult HourDetailIndex(RPTDailyDataViewModel model)
        {
            RPTDailyDataViewModel HourDetailModel = new RPTDailyDataViewModel();
            string strDateTime = "";
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult QueryModuleHourForCharts(RPTDailyDataViewModel model)
        {
            MethodReturnResult result = new MethodReturnResult();
            SortedList<string, string> svalues = new SortedList<string, string>();
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult QueryModuleHour(RPTDailyDataViewModel model)
        {
            MethodReturnResult result = new MethodReturnResult();
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult ItemIndex(RPTDailyDataViewModel model)
        {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult QueryModuleItemForCharts(RPTDailyDataViewModel model)
        {
            MethodReturnResult result = new MethodReturnResult();
            SortedList<string, string> svalues = new SortedList<string, string>();
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public ActionResult QueryModuleItem(RPTDailyDataViewModel model)
        {
            MethodReturnResult result = new MethodReturnResult();
