...
namespace ServiceCenter.Client.Mvc.Areas.LSM.Models
{
    ...
    public class MaterialLoadingViewModel
    {
        ...
        [Required(ErrorMessage="开始批次不能为空")]
        [Display(Name = "MaterialLoadingViewModel_StartLot", ResourceType = typeof(LSMResources.StringResource))]
        public string StartLot { get; set; }

        [Required(ErrorMessage = "结束批次不能为空")]
        [Display(Name = "MaterialLoadingViewModel_EndLot", ResourceType = typeof(LSMResources.StringResource))]
        public string EndLot { get; set; }
    ...
    public class MaterialLoadingDetailViewModel
    {
        ...
        /// </summary>
        //[Required]
        //[Display(Name = "MaterialLoadingDetailViewModel_MaterialName", ResourceType = typeof(LSMResources.StringResource))]
        ...
        /// </summary>
        //[Required]
        [Display(Name = "MaterialLoadingDetailViewModel_SupplierCode", ResourceType = typeof(LSMResources.StringResource))]
