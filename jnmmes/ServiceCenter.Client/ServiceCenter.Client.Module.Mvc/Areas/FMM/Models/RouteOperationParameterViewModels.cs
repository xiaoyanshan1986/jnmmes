...
{
    public class RouteOperationParameterQueryViewModel
    {
        public RouteOperationParameterQueryViewModel()
        {

        }
        [Display(Name = "RouteOperationParameterQueryViewModel_RouteOperationName", ResourceType = typeof(FMMResources.StringResource))]
        public string RouteOperationName { get; set; }

        [Display(Name = "RouteOperationParameterQueryViewModel_ParameterName", ResourceType = typeof(FMMResources.StringResource))]
        public string ParameterName { get; set; }
    }

    public class RouteOperationParameterViewModel
    {
        public RouteOperationParameterViewModel()
        {
        ...
        [Required]
        [Display(Name = "RouteOperationParameterViewModel_RouteOperationName", ResourceType = typeof(FMMResources.StringResource))]
