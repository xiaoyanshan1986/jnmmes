...
namespace ServiceCenter.Client.Mvc.Areas.FMM.Models
{
    public class ClientConfigAttributeQueryViewModel
    {
        ...
        [Display(Name = "ClientConfigAttributeQueryViewModel_ItemNo", ResourceType = typeof(FMMResources.StringResource))]
    ...
    public class ClientConfigAttributeViewModel
    {
        ...
        [Required]
        [Display(Name = "ClientConfigAttributeViewModel_ItemNo", ResourceType = typeof(FMMResources.StringResource))]
        [Range(1, 65536
