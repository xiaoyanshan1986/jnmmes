...
{
    public class LotScrapQueryViewModel
    {
        public LotScrapQueryViewModel()
        {
    ...
    public class LotScrapViewModel
    {
        public LotScrapViewModel()
        {
        ...
        [Display(Name = "LotScrapViewModel_RouteOperationName", ResourceType = typeof(WIPResources.StringResource))]
        [StringLength(50, MinimumLength = 1
                , ErrorMessageResourceName = "ValidateStringLength"
                , ErrorMessageResourceType = typeof(StringResource))]
        [RegularExpression("[^,]+"
        ...
        [Display(Name = "LotScrapViewModel_ResponsiblePerson", ResourceType = typeof(WIPResources.StringResource))]
        [StringLength(50, MinimumLength = 1
                , ErrorMessageResourceName = "ValidateStringLength"
                , ErrorMessageResourceType = typeof(StringResource))]
        [RegularExpression("[^,]+"
        ...
        [Range(1, 65536
                ...
                , ErrorMessageResourceType = typeof(StringResource))]
        [Display(Name = "LotScrapViewModel_ScrapQuantity", ResourceType = typeof(WIPResources.StringResource))]
