...
namespace ServiceCenter.Client.Mvc.Areas.ZPVC.Models
{
    public class BoxViewModel
    {
        public BoxViewModel()
        {
            this.FullQuantity = 1000;
            this.PrintQty = 1;
        }

        [Required]
        [Display(Name = "BoxViewModel_PackageNo", ResourceType = typeof(ZPVCResources.StringResource))]
        ...
        /// </summary>
        [Required]
        [Display(Name = "BoxViewModel_FullQuantity", ResourceType = typeof(ZPVCResources.StringResource))]
        ...
        /// </summary>
        [Required]
        [Display(Name = "BoxViewModel_CurrentQuantity", ResourceType = typeof(ZPVCResources.StringResource))]
